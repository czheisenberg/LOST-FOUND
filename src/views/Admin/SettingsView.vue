...
<!--              </li>-->
              <li>
                <div class="flex items-center">
                  <svg class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                  <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">网站设置</span>
                </div>
              </li>
            </ol>
          </nav>
          <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">网站设置</h1>
        </div>
      </div>
...
const description = ref("校园失物招领系统——LOST&FOUND平台,通过整合线上线下资源，构建高效便捷的信息交互平台，不仅能快速解决师生们的失物问题，提升校园生活的便利性和秩序性，还能营造良好的校园文化氛围，强化师生之间的互助与关爱。同时，随着技术的不断发展和完善，该系统有望与校园其他管理系统深度融合，拓展更多功能和服务，进而辐射到周边社区乃至更广泛的区域，成为连接校园内外的重要桥梁，为构建更加和谐、智慧的校园环境发挥关键作用。")
